...
public class Home extends AppCompatActivity implements Profile.OnFragmentInteractionListener, Statistics.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabLayout.addTab(mTabLayout.newTab().setText("Weight Entry"));
